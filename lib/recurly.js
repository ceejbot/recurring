...
function Recurring()
{
	...
	function skipAuth(val)
	{
		SKIP_AUTH = val ? true : false;
		this.SKIP_AUTH = SKIP_AUTH;
		debug('Setting Recurly-Skip-Authorization header to %s', SKIP_AUTH);
	}
	...
	RecurlyData.base_options = function()
	{
		return {
			headers:
			{
				...
				'Recurly-Skip-Authorization': SKIP_AUTH
			}
		};
	};
	...
	Recurring.prototype.skipAuth = skipAuth;
